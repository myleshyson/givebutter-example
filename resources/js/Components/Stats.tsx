            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:max-w-none">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-lg/8 text-base">
                            Your Safe Place is committed to providing
                            comprehensive, confidential support to people
                            experiencing domestic violence, family violence,
                            sexual assault, sex trafficking, strangulation, and
                            older/dependent abuse.{" "}
                        </p>
                    </div>
                    <dl className="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-3">
                        {stats.map((stat) => (
                            ...
                            >
                                <dt className="text-sm/6 font-semibold text-base">
                                    {stat.name}
                                </dt>
                                <dd className="order-first text-3xl font-extrabold tracking-tight text-base">
                                    {stat.value}
                                </dd>
                            </div>
                        ))}
